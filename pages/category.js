...
// @inject(({categoryStore: {getCategoryIdByNm}}, props) => ({
//     currentCategoryId: getCategoryIdByNm(props.router.query.title),
//   }))
@inject("categoryStore")
class Category extends React.Component {

    static async getInitialProps ({store: {categoryStore}, query}) {
        const id = await categoryStore.getCategoryIdByNm(query.title)

        console.log("getafadfqq:", id)
    }
